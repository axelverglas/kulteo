  ...
  return (
    ...
    <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="my-6 md:w-[420px] text-center">
          Vous êtes un passionné de culture et notre projet vous intéresse ?
          Inscrivez-vous à notre newsletter !
        </p>
        <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-[420px]">
          <div className="relative">
            <input
              type="email"
              {...register('email')}
              className="w-full h-16 rounded-[3rem] border-[3px] border-secondary bg-transparent px-6 text-white outline-none"
              placeholder="Email..."
            />
            <button
              type="submit"
          ...
          <div className="mt-8 flex items-start">
            ...
            />
            <label className="ml-2 block w-full md:w-[405px] text-xs">
