  ...
  return (
    <section className="bg-slate-50 py-12 dark:bg-black md:py-24">
      <div className="container max-w-7xl">
        <h2 className="font bold mb-10 text-center font-roc text-3xl md:text-4xl">
          Ô
  ...
  return (
    <div className="flex justify-center">
      <div className="w-[250px]">
        <h3 className="text-center font-roc text-4xl font-bold text-secondarylight dark:text-primary">
          {percentage}
        </h3>
